    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Button
                    variant="ghost"
                    className="w-10 h-10 md:w-auto md:px-4 bg-white/5 border border-white/10 hover:bg-blue-600 transition-all group rounded-full"
                >
            ...
            <DialogContent className="max-w-2xl bg-[#0C1121]/95 backdrop-blur-3xl border-white/10 p-0 overflow-hidden rounded-[2rem] shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                <DialogHeader className="p-6 border-b border-white/5 bg-gradient-to-br from-white/5 to-transparent">
                    ...
                    <div className="relative mt-4 group">
                        ...
                        <Input
                            id="search"
                            className="h-14 pl-12 pr-12 bg-white/5 border-white/10 focus:border-blue-500/50 focus:ring-blue-500/20 rounded-2xl text-lg placeholder:text-gray-600 outline-none transition-all"
                    ...
                    <AnimatePresence mode="popLayout">
                        {albums.length > 0 ? (
                            <motion.div
                                ...
                                className="space-y-4"
                            >
                                <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-4">Kết quả tìm kiếm ({albums.length})</p>
                ...
                {/* Bottom Decor */}
                <div className="h-1 bg-gradient-to-r from-blue-600 via-purple-600 to-transparent opacity-50"></div>
            </DialogContent>
        </Dialog>
    );
}
