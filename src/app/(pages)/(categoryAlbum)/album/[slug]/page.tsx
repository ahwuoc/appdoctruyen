              ...
              >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8 text-sm text-gray-400">
                  <div className="flex items-center gap-2 justify-center md:justify-start">
                    <CiWifiOn className="text-blue-400 text-xl" />
                    <span>{albumData.is_active ? "Đang cập nhật" : "Hoàn thành"}</span>
                  </div>
                  <div className="flex items-center gap-2 justify-center md:justify-start">
                  ...
                  <div className="flex items-center gap-2 justify-center md:justify-start">
                    <AiOutlineHeart className="text-pink-400 text-xl" />
                    <span>2,345 theo dõi</span>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-white/10 bg-white/5 hover:bg-white/10 rounded-xl px-8 font-bold gap-2"
                  >
                    <AiOutlineHeart className="text-lg" /> Theo dõi
                  </Button>
                </div>
              </motion.div>
            </div>
