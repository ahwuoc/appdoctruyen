  ...
  return (
    <div className='container relative min-w-full  min-h-full  '>
      ...
      <div className='absolute top-0 left-0 z-200 bg-gray-500 bg-opacity-50 right-0 bottom-0'>
        <div className="z-20 p-4 min-h-full flex-col gap-y-5 flex text-white container my-5 rounded-sm mx-auto bg-customBg w-[80%]">
          ...
          <div className='product_list_chapter'>
            ...
            <div className="product_list_chapter_bottom container mt-5">
                <Table className=' border-customBg2  border-2'>
                  <TableCaption>Danh sách chapter mới nhất</TableCaption>
                  <TableHeader className=''>
                    <TableRow className=''>
                      <TableHead className='font-bold text-xl'>Chapter</TableHead>
                      <TableHead className="font-bold text-xl">Cập nhật</TableHead>
                      <TableHead className='font-bold text-xl'><MdOutlineRemoveRedEye /></TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    <TableRow>
                      <TableCell>Chapter 2</TableCell>
                      <TableCell>24 ngày trước</TableCell>
